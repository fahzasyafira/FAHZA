...
<head>
	...
	<link rel="icon" href="assets/images/telkom2.png" type="image/ico" />
    ...
    <div class="container body">
        ...
        <div class="col-md-3 left_col">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">ADMIN Lokerisel</font></span></a>
            </center>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="dashboard.php"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron"></span></a>
                    </li>
                    ...
                    <li><a href="#"><i class="fab fa-blogger-b"></i> Blog <span class="fa fa-chevron"></span></a>
                    </li>
                    <li><a href="#"><i class="fas fa-thumbs-up"></i> Approve Umkm <span class="fa fa-chevron"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="indexA.php?page=approve_umkm">Dipending</a></li>
                        <li><a href="#">Diterima</a></li>
                        <li><a href="i#">Ditolak</a></li>
                    </ul>
                    </li>
                    <li><a href="#"><i class="fas fa-percent"></i> Insert Promo <span class="fa fa-chevron"></span></a>
                    </li>
                    <li><a href="#"><i class="fas fa-money-check-alt"></i> Transaksi <span class="fa fa-chevron-down"></span></a>
                    </li>
                    <li><a href="#"><i class="fas fa-link"></i> Komplain <span class="fa fa-chevron"></span></a>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div class="sidebar-footer hidden-small">
                ...
                <a data-toggle="tooltip" data-placement="top" title="Logout" href="LOGIN PEMWEB/learn.php">
        ...
        <div class="top_nav">
            <div class="nav_menu">
                ...
                <li class="nav-item dropdown open" >
                    ...
                    <a class="dropdown-item"  href="LOGIN PEMWEB/learn.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </div>
                </li>
