                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['id_transaksi'])) {
                                        $update = mysqli_query($koneksi, "UPDATE transaksi set status = 'selesai' where id_transaksi='" . $_GET['id_transaksi'] . "'") or die(mysqli_error($koneksi));
                                        $sql = "SELECT * FROM transaksi JOIN pembayaran ON transaksi.id_transaksi=pembayaran.id_transaksi WHERE status='selesai' ";
                                    }
                                    $no = "1";
