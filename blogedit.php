<?php include('config.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="indexr.php?page=Blogger";</script>';
			}else{
		...
		<form action="blogedit.php?id_blog=<?php echo $id_blog; ?>" method="post">
