        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron"></span></a>
                  </li>
                  ...
                  <li><a href="inbox.php"><i class="fa fa-envelope-o"></i> Chatting <span class="fa fa-chevron"></span></a>
                  </li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="LOGIN PEMWEB/learn.html">
